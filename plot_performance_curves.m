...
figure()
plot(1:NEpisodes,sum(oracle_bill(1:NEpisodes),2))
hold on
plot(1:NEpisodes,sum(actual_bill_la(1:NEpisodes),2))
plot(1:NEpisodes,sum(actual_bill(1:NEpisodes),2))
...
legend('Static Agent','Linear RL Agent','NN RL Agent');
